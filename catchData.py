...
driver = webdriver.Chrome('C:\Users\wen\Desktop\chromedriver.exe')
#將已存檔案製成列表
...
for year in range(91,105):
    ...
    for mon in range(1,((12/interval_month)+1)):
        ...
        Select(driver.find_element_by_name("v_court")).select_by_visible_text(u"臺灣嘉義地方法院")
        ...
        for pages in range(1,int(page.group(3))):
            time.sleep(5)
            raw_page=driver.page_source
